...
export default function Header() {
	...
	return (
		<div className="flex justify-between pr-[24px] items-center w-full h-[72px] bg-[#373B53] dark:bg-[#1E2139] md:h-[80px] xl:flex-col xl:h-[100vh] xl:w-[103px] xl:pr-[0px] xl:pb-[24px] xl:rounded-r-[20px] xl:fixed xl:z-[999999999]">
