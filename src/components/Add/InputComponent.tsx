  ...
  return (
    <div className="flex flex-col items-start justify-center gap-[20px] w-[327px]  box-border py-[10px] ">
      ...
      <input
        // type={type ? type : "text"}
        style={{ opacity: color }}
        className={`w-[327px] h-[48px] rounded-md border border-gray-300 bg-white   font-league-spartan text-[13px] font-bold leading-4 tracking-tight px-[20px] dark:bg-[#1E2139] dark:text-white dark:border-none`}
        id={id}
