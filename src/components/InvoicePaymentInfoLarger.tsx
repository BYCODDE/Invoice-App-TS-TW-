				...
				<div className="flex flex-col gap-[32px]">
					<div className="flex items-center justify-between">
						...
						<div className="flex justify-center gap-[40px]">
							<h3 className="text-[13px] font-medium leading-[18px] tracking-[-0.1px] text-[#7E88C3] dark:text-[#DFE3FA] w-[65px] text-center">
								QTY.
							</h3>
							<h3 className="text-[13px] font-medium leading-[18px] tracking-[-0.1px] text-[#7E88C3] dark:text-[#DFE3FA] w-[65px] text-center">
								Price
					...
					{choosenInvoice?.items.map((item, index) => {
						return (
							<div className="flex items-center justify-between" key={index}>
								...
								<div className="flex justify-center gap-[40px]">
									<p className="text-[13px] font-medium leading-[18px] tracking-[-0.1px] text-[#7E88C3] dark:text-[#DFE3FA] w-[65px] text-center">
										{item.quantity}
									</p>
									<p className="text-[13px] font-medium leading-[18px] tracking-[-0.1px] text-[#7E88C3] dark:text-[#DFE3FA] w-[65px] text-center">
