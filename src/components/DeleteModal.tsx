    ...
    >
      ...
      >
        ...
        <div className="flex justify-end gap-[8px] mt-[22px]">
          <button
            className="pt-[18px] px-[24px] pb-[15px] bg-[#F9FAFE] dark:bg-[#252945] text-[#7E88C3] dark:text-[#DFE3FA] rounded-[24px] text-[15px] font-bold leading-[15px] tracking-[-0.25px] xl:hover:bg-[#DFE3FA]"
            onClick={() => setIsDeleteOpen(false)}
          >
            Cancel
          </button>
